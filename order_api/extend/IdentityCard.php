...
class IdentityCard
{
    ...
    /**
     * People's Republic of China provincial administrative divisions code (excluding Hong Kong, Macao and Taiwan
     * regions).
     *
     * @var  array
     */
