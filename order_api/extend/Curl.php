 ...
 * GET:     $curl->url(目标网址);
 * POST:    $curl->post(变量名, 变量值)->post(多维数组)->url(目标网址);
 * UPLOAD:  $curl->post(多维数组)->file($_FILE字段, 本地路径, 文件类型, 原始名称)->url(目标网址);
 * DOWNLOAD:$curl->url(文件地址)->save(保存路径);
 * 配置:  参考:http://php.net/manual/en/function.curl-setopt.php
